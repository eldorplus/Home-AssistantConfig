...
This is my live(-ish) [Home Assistant](https://home-assistant.io/) Core configuration, This instance is running 2024.10.4 
...
* [Home Assistant](https://home-assistant.io/) (2024.10.4)
* [traefik](https://traefik.io/) (3.1.6) with [ZeroSSL](https://zerossl.com/) for remote access (replaced NGINX)
* [Zigbee2MQTT](https://www.zigbee2mqtt.io/) (1.39.0) for Zigbee
...
For Zigbee I use [Zigbee2MQTT](https://www.zigbee2mqtt.io/) (version 1.39.0) running on another system. I use this instead of ZHA because my experience with Z-Wave taught me the value of separation.
